...
function notifyJobSeeker(toEmployId,state) {
    console.log("id:"+toEmployId+",state:"+state)
    $.ajax({
        type:"get",
        url:"/company/notifyJobSeeker",
        data:{
...
$(function() {
    ...
    var json = GetRequest();
    var recruitmentId = json.recruitmentId;
    console.log(recruitmentId);

    $.ajax({
        type:"post",
        url:"/company/getToEmployResume",
        data:{
        ...
        success:function (data) {
            if (data.state == 10){
                var a,b,c,i;
                for(a = data.list,i = data.toList,b = 0,c="";b<a.length;b++){
                    c+="<li data-id=\""+a[b].resumeId+"\" class=\"onlineResume\">\n" +
                        "                                    <i></i>\n" +
                        "                                </label>\n" +
                        "                                <div class=\"resumeShow\">"+
                        "<a title=\"预览在线简历\" target=\"_blank\" class=\"resumeImg\"\n" +
                        "                                       href=\"/htmls/preview.html?resumeId="+a[b].resumeId+"\">\n" +
                        "                                        <img src=\""+a[b].imgName+"\">\n" +
                        "                                    </a>\n" +
                        "                                    <div class=\"resumeIntro\">\n" +
                        "                                        <h3 class=\"unread\">\n" +
                        "                                            <a target=\"_blank\" title=\"预览"+a[b].name+"的简历\"\n" +
                        "                                               href=\"/htmls/preview.html?resumeId="+a[b].resumeId+"\">\n" +
                        "                                                "+a[b].resumeName+"\n" +
                        "                                            </a>\n" +
                        "                                            <em></em>\n" +
                        "                                        </h3>\n" +
                        "                                        <span class=\"fr\">投递时间："+i[b].toEmployDate+"</span>\n" +
                        "                                        <div>\n" +
                        "                                            "+a[b].name+" / "+a[b].sex+" / "+a[b].education+" / "+a[b].jobExp+" / "+a[b].exceptionCity+" <br>\n" +
                        "                                            "+a[b].major+" | "+a[b].education+" · "+a[b].university+"\n" +
                        "                                        </div>\n" +
                        "                                        <div class=\"jdpublisher\">\n" +
                        "\t\t\t\t                                        <span>\n" +
                        "\t\t\t\t                                        \t应聘职位：<a title=\""+i[b].recruitment.jobName+"\" target=\"_blank\"\n" +
                        "                                                                    href=\"/company/findJob?createTime="+i[b].recruitmentId+"\">"+i[b].recruitment.jobName+"</a>\n" +
                        "\t\t\t\t                                       \t\t\t\t\t\t                                        </span>\n" +
                        "                                        </div>\n" +
                        "                                    </div>\n" +
                        "                                    <div class=\"links\">\n" +
                        "                                        <a \n" +
                        "                                           href=\"javascript:void(0)\" onclick=\"notifyJobSeeker(\'"+i[b].toEmployId+"\',1)\">通知面试</a>\n" +
                        "                                        <a data-deliverid=\"1686182\" class=\"resume_refuse\"\n" +
                        "                                           href=\"javascript:void(0)\" onclick=\"notifyJobSeeker(\'"+i[b].toEmployId+"\',2)\">不合适</a>\n" +
                        "                                    </div>"+
                        "</div>\n" +
                        "                                <div class=\"contactInfo\">\n" +
                        "                                    <span class=\"c9\">电话：</span>"+a[b].phone+" &nbsp;&nbsp;&nbsp;\n" +
                        "                                    <span class=\"c9\">邮箱：</span><a href=\"mailto:"+a[b].email+"\">"+a[b].email+"</a>\n" +
                        "                                </div>\n" +
                        "                            </li>"
                }
                $("a").parent().removeClass("current")
                if (json.state == 3)
                    $(".company_center_content h1").text("我收到的简历")
                else {
                    $(".r"+json.state).parent().addClass("current")
                    $(".company_center_content h1").text($(".r"+json.state).text())
                }
                $(".resumeLists").html(c)
            }
        }
