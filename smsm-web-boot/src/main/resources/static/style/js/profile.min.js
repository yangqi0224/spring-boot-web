...
function img_check(a, b, c) {
    ...
    this.AllowExt = ".jpg,.gif,.jpeg,.png,.pjpeg", this.FileExt = a.val().substr(a.val().lastIndexOf(".")).toLowerCase(), 0 != this.AllowExt && -1 == this.AllowExt.indexOf(this.FileExt) ? errorTips("只支持jpg、gif、png、jpeg格式，请重新上传", "上传头像") : ($("#" + c + "_error").text("").hide(), $.ajaxFileUpload({
        ...
        success: function (a) {
            ...
            if (a.state == 10) {
                var b = a.fileName;
                $("#portraitShow img").attr("src", "/style/images/upload/" + b), $("#basicInfo .basicShow img").attr("src", "/style/images/upload/" + b), $("#portraitNo").hide(), $("#portraitShow").show()
                ...
                submitHandler: function (a) {
                    ...
                    $(a).find(":submit").val("保存中...").attr("disabled", !0),
                        ...
                        /*$("#resubmitToken").val(b.resubmitToken),*/
                            b.state==10 ? (c = b.resume.projectExp,
                                e = "", 4 == b.code ? "" != c ? (e += '<li data-id="' + c.projectExpId + '">',
                                e += '<div class="projectList"><i class="sm_del dn"></i><i class="sm_edit dn"></i><div class="f16 mb10" data-proName="' +
                                    c.projectExpName + '" data-posName="' + c.projectExpDuty + '" data-startY="'
                                    + c.beginTimeYear + '" data-startM="' + c.beginTimeMonth + '" data-endY="'
                                    + c.endTimeYear + '"' + 'data-endM="' + c.endTimeMonth + '">'
                                    + c.projectExpName + '<span class="c9">（' + c.startDate + "-"
                                    + c.endDate + "）</span></div>",
                            "" != c.dutyContent && (e += '<div class="dl1">'
                                + c.dutyContent + "</div>"), e += "</div></li>",
                            "" != $.trim(d.obj.children(".projectShow").children(".plist").html()) && $(a).remove(),
                                d.obj.children(".c_add").removeClass("dn"), d.obj.children(".projectShow").children(".plist").prepend(e),
                                d.obj.children(".projectShow").removeClass("dn"),
                                d.obj.children(".projectEdit").addClass("dn")) : "" != $.trim(d.obj.children(".projectShow").children(".plist").html()) ?
                                ($(a).remove(), d.obj.children(".c_add").removeClass("dn")) :
                                (d.obj.children(".projectEdit").addClass("dn"),
                                    d.obj.children(".projectAdd").removeClass("dn")) : 3 == b.code ?
                                (e += '<div class="projectList"><i class="sm_del dn"></i><i class="sm_edit dn"></i><div class="f16 mb10" data-proName="' +
                                    c.projectExpName + '" data-posName="' + c.projectExpDuty + '" data-startY="' +
                                    c.beginTimeYear + '" data-startM="' + c.beginTimeMonth + '" data-endY="' +
                                    c.endTimeYear + '"' + 'data-endM="' + c.endTimeMonth + '">' +
                                    c.projectExpName + '<span class="c9">（' + c.startDate + "-" + c.endDate + "）</span></div>",
                                "" != c.dutyContent && (e += '<div class="dl1">' + c.dutyContent + "</div>"),
                                    e += "</div>", $(a).parent("li").html(e)) : 2 == b.code && ($(a).parent("li").remove(),
                            0 == d.obj.children(".projectShow").children(".plist").children("li").length && d.AddCancel),
                                ...
                                $("#lastChangedTime span").text(c.updateTime),
                                //$("#resumeScore .which span").attr("rel", b.content.infoCompleteStatus.nextStage),
                                scoreChange(50), k(d.obj),
                            /*b.content.isNew*/true && changeAllIds(c.projectExpId)) : alert(b.msg),
                            $(a).find(":submit").val("保 存").attr("disabled", !1)

                            $(".projectId").val(c.projectExpId)
                    })
                }
            })
        })
    ...
    window.onbeforeunload = function () {
        ...
        messages: {
            ...
            email: {
                ...
                email: "请输入有效的常用邮箱，如：123@123.com",
                maxlength: "请输入有效的常用邮箱，如：123@123.com"
            },
        ...
        Edit: function (a) {
            ...
            a.parent("li").find("img").attr("src"), h = a.parent("li").find("h4").text(), i = a.parent("li").find("h3").text(), this.obj.children(".experienceShow").find(".companyName").val(i), this.obj.children(".experienceShow").find(".positionName").val(h), this.obj.children(".experienceShow").find(".companyYearStart").val(c), this.obj.children(".experienceShow").find(".select_companyYearStart").css("color", "#333").val(c), this.obj.children(".experienceShow").find(".companyMonthStart").val(e), this.obj.children(".experienceShow").find(".select_companyMonthStart").css("color", "#333").val(e), this.obj.children(".experienceShow").find(".companyYearEnd").val(d), this.obj.children(".experienceShow").find(".select_companyYearEnd").css("color", "#333").val(d), this.obj.children(".experienceShow").find(".companyMonthEnd").val(f), this.obj.children(".experienceShow").find(".select_companyMonthEnd").css("color", "#333").val(f), this.obj.children(".experienceShow").find(".expId").val(b), this.obj.children(".experienceShow").children(".experienceForm").show(), "至今" == $.trim(f) && this.obj.children(".experienceShow").find(".select_companyMonthEnd").unbind("click"), this.companyNameVal = i, this.positionNameVal = h, this.companyYearStartVal = c, this.companyMonthStartVal = e, this.companyYearEndVal = d, this.companyMonthEndVal = f, this.obj.children(".c_add").addClass("dn"), j(this.obj)
        },
        Del: function (a) {
            var b = a.parent("li").attr("data-id");
            $.ajax({url: "/personal/delWorkHis", type: "POST", data: {workHistoryId: b}}).done(function (b) {
                b.state == 10 ? (a.parent("li").remove(), "" == b.resume.workHistories || null == b.resume.workHistories ? (c.obj.children(".experienceShow").addClass("dn"), c.obj.children(".experienceEdit").addClass("dn"), c.obj.children(".experienceAdd").removeClass("dn"), c.obj.children(".c_add").addClass("dn")) : c.obj.children(".experienceShow").children(".experienceForm").hide(), $("#lastChangedTime span").text(b.resume.updateTime), k(c.obj), true && changeAllIds(1)) : alert(b.msg);
                if (b.resume.workHistories.length == 0){
                    console.log("workHistories = null")
        ...
        $(this).validate({
            ...
            messages: {
                companyName: {required: "请输入有效的公司名称，如：百度", maxlenStr: "请输入有效的公司名称，如：百度"},
                positionName: {
            ...
            submitHandler: function (a) {
                ...
                $(a).find(":submit").val("保存中...").attr("disabled", !0), $.ajax({
                    ...
                    var d, e, f;
                    if (b.state == 10) {
                        for (d = b.resume.workHistories, e = "", f = 0; f < b.resume.workHistories.length; f++)
                        ...
                        c.obj.children(".c_add").removeClass("dn"),
                            ...
                            k(c.obj),$("#workExperience .experienceShow .wlist").removeClass("dn")
        ...
        obj: $("#projectExperience"), resetForm: function () {
            ...
            l && (l = $.trim(l.replace(/<br>/gi, ""))), this.resetForm(), m = this.obj.children(".projectEdit").children("form").clone(), m.find(".projectName").val(d), m.find(".thePost").val(f), "" != g && (m.find(".projectYearStart").val(g), m.find(".select_projectYearStart").css("color", "#333").val(g)), "" != h && (m.find(".projectMonthStart").val(h), m.find(".select_projectMonthStart").css("color", "#333").val(h)), "" != i && (m.find(".projectYearEnd").val(i), m.find(".select_projectYearEnd").css("color", "#333").val(i)), "" != k && (m.find(".projectMonthEnd").val(k), m.find(".select_projectMonthEnd").css("color", "#333").val(k)), "至今" == $.trim(k) && m.find(".select_projectMonthEnd").unbind("click"), m.find(".projectDescription").val(l), m.find(".projectId").val(c), a.parents("li").prepend(m), placeholderFn(), a.parents("li").children(".projectList").addClass("dn"), e(), j(this.obj)
        }, Del: function (a) {
            var b = a.parents("li").attr("data-id");
            $.ajax({url: "/personal/delProExp", type: "POST", data: {projectExpId: b}}).done(function (b) {
                b.state==10 ? (a.parents("li").remove(), $("ul.plist li:last-child").addClass("noborder"), ("" == b.resume.projectExps || null == b.resume.projectExps) && (d.obj.children(".projectShow").addClass("dn"), d.obj.children(".projectEdit").addClass("dn"), d.obj.children(".projectAdd").removeClass("dn"), d.obj.children(".c_add").addClass("dn")), $("#lastChangedTime span").text(b.resume.updateTime), k(d.obj), true && changeAllIds(1)) : alert(b.msg);
            })
        }, AddCancel: function () {
