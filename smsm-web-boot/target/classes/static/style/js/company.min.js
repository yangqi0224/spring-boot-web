    ...
    this.AllowExt = ".jpg,.gif,.jpeg,.png,.pjpeg",
        ...
        0 != this.AllowExt && -1 == this.AllowExt.indexOf(this.FileExt) ? errorTips("只支持jpg、gif、png、jpeg格式，请重新上传") : $.ajaxFileUpload({
            ...
            success: function(result) {
                b = result.fileName;
                result.state == 10 ? ($("#companyLogo").attr("src", "/style/images/upload/" + b), $("#logoNo").hide(), $("#logoShow").show()) : errorTips("上传失败，请重新上传", "上传公司logo")
            }
        })
}
    ...
    $.ajax({
        ...
        success:function (data) {
            ...
            if (data.company != null){
                $(".companyName h2").html(c.companyName)
                $(".companyName h2").attr("title",c.companyName)
                $("#companyLogo").attr("src",c.imgName)

                $(".companyName h1").html(c.companyName)
                $(".companyName h1").attr("title",c.companyName)

                $("#companyShortName").val(c.companyName)
                $("#companyFeatures").val(c.companyPresent)

                console.log(c.companyPresent)
                $("#oneword").html(c.companyPresent)

                $("#companyProfile").text(c.companyMerit)
                $(".c_intro").text(c.companyMerit)

                $("#city").val(c.companyLocation)
                $("#companyUrl").val(c.companyHome)

                $("#companySize").val(c.companySize)
                $("#select_sca").val(c.companySize)

                $(".ccity").html(c.companyLocation)
                $(".csize").html(c.companySize)
                $(".chome").html(c.companyHome)
                $(".chome").attr("title",c.companyHome)
                $(".chome").attr("href",c.companyHome)

                $("#comCity").val(c.companyLocation)
                $("#comSize").val(c.companySize)
                $("#comUrl").val(c.companyHome)
            ...
            submitHandler: function(a) {
                ...
                $(a).find(":submit").attr("disabled", !0),
                    $.ajax({
                        ...
                        b.state == 10 ? ("" != b.company.companyName ? ($(".c_box h2").text(b.company.companyName),
                            $(".c_box h2").attr("title", b.company.companyName),
                            $(".c_box h1.fullname").show()) : ($(".c_box h2").text($(".c_box h1.fullname").text()),
                            $(".c_box h2").attr("title", $(".c_box h1.fullname").attr("title")),
                            $(".c_box h1.fullname").hide()), $(".oneword span").text(b.company.companyPresent),
                            "none" == $("#addLabels").css("display") ? ($(".editDetail").hide(), $("#editCompanyDetail").show(),
                                $(".c_detail").removeClass("c_detail_bg"), $(".c_box .oneword").show()) : ($(".editDetail").hide(),
                                $("#editCompanyDetail").show(), $(".c_box .oneword").show())) : $("#beError").text(b.msg).show(),
                            $(a).find(":submit").attr("disabled", !1)
                    })
            }
        }),
            ...
            submitHandler: function(a) {
                ...
                $(a).find(":submit").attr("disabled", !0),
                    $.ajax({
                        ...
                        if (b.state == 10) if ("" == b.content) $("dl:nth-child(1)", d).show(),
                            ...
                            var c = b.company.companyMerit;
                            c && (c = $.trim(c.replace(/<br \/>/gi, ""))),
                                $("dl:nth-child(2) textarea", d).val(c),
                                $("dl:nth-child(2)", d).hide(),
                                $("dl:nth-child(3) .c_intro", d).html(c),
            ...
            submitHandler: function(a) {
                ...
                $(a).find(":submit").attr("disabled", !0),
                    $.ajax({
                        ...
                        b.state == 10 ? ($("#city", a).val(c), $("#industryField", a).val(d),
                            $("#companySize", a).val(e), $("#companyUrl", a).val(f), $("#comCity", a).val(c),
                            $("#comInd", a).val(d), $("#comSize", a).val(e),
                            $("#comUrl", a).val(f), -1 != f.indexOf("http://") || -1 != f.indexOf("https://") ?
                            $("#c_tags_show table").html("<tr><td>地点</td><td>" + b.company.companyLocation + "</td></tr>" + "<tr><td>规模</td><td>" + b.company.companySize + "</td></tr>" + '<tr><td>主页</td><td><a href="' + b.company.companyHome + '" target="_blank">' + b.company.companyHome + "</a></td></tr>") : $("#c_tags_show table").html("<tr><td>地点</td><td>" + b.company.companyLocation + "</td></tr>" + "<tr><td>领域</td><td>" + b.company.companyField + "</td></tr>" + "<tr><td>规模</td><td>" + b.company.companySize + "</td></tr>" + '<tr><td>主页</td><td><a href="http://' + b.company.companyHome + '" target="_blank">' + b.company.companyHome + "</a></td></tr>"), $("#c_tags_show").show(), $("#c_tags_edit").hide()) : alert("保存失败"),
                            $(a).find(":submit").attr("disabled", !1)
                    })
            }
        }),
